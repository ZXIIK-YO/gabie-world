...
export type Item={id:string;category:string;name:string;status:string;priority:string;planned:number;paid:number;owned:boolean;favorite:boolean;targetPrice?:number;url?:string};
